...
export class PessoaFisicaComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.pessoaFisicaService
      ...
      .subscribe({
        next: (res: HttpResponse<IPessoaFisica[]>) => {
  ...
  trackId(_index: number, item: IPessoaFisica): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IPessoaFisica[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/pessoaapplication/pessoa-fisica'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
